...
<?php require base_path("views/partials/nav.php"); ?>
    ...
    <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">Edit Task</h2>
        ...
        <form method="POST" action="/task">
            ...
            <div class="flex justify-end mt-6 gap-x-3">
                <a href="/"
                        class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-500 rounded-md hover:bg-blue-500">
                    Cancel
                </a>
                <button type="submit"
